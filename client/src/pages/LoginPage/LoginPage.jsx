      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#2C1810] via-[#3D2418] to-[#5C322A] flex-col items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-sm">
          ...
          <p className="text-[#D4A398] leading-relaxed text-sm font-light">
            Your curated destination for premium local products. Quality,
            elegance, and trust — delivered to your door.
          </p>
          ...
          <div className="mt-10 grid grid-cols-2 gap-4 text-left">
            {[
              ...
              <div
                key={title}
                className="bg-white/5 backdrop-blur-md rounded-2xl p-3.5 border border-white/10 shadow-[0_4px_12px_rgba(0,0,0,0.1)]"
              >
                <span className="text-lg">{emoji}</span>
                <p className="text-white text-xs font-bold mt-1.5 font-['Outfit']">
                  {title}
                </p>
                <p className="text-[#D4A398] text-[10px] mt-0.5 font-light">
                  {desc}
                </p>
              </div>
            ))}
          ...
          <div className="bg-white rounded-3xl border border-[#E8D4D0]/60 shadow-[0_12px_48px_rgba(44,24,16,0.04)] p-8">
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  type="button"
                  className="text-sm text-[#E7A9A2] hover:text-[#E29A8F] font-medium cursor-not-allowed opacity-60"
                >
                  Forgot password?
                </button>
              </div>
